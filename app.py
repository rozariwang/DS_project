...
def main():
    ...
    st.empty()
    st.markdown("<p style='font-size: 12px; margin-top: -15px;'>You can either select a company from the list below or simply type in your selection.</p>", unsafe_allow_html=True)
